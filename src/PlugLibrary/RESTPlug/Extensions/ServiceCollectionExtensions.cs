...
namespace RESTPlug.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            services
                .AddScoped<IPlugCommonSettingContent, Services.RESTPlugCommonSettingContent>()
                .AddScoped<IPlugCommonExecute, RESTPlugCommonExecuteService>();
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddRESTExecute(this IServiceCollection services)
        {
            services
                .AddScoped<IPlugCommonExecute, RESTPlugCommonExecuteService>();
