...
namespace MatlabPlug.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddMatlab(this IServiceCollection services)
        {
            services
                .AddScoped<IPlugCommonSettingContent, Services.MatlabPlugCommonSettingContent>()
                .AddScoped<IPlugCommonExecute, MatlabPlugCommonExecuteService>();
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddMatlabExecute(this IServiceCollection services)
        {
            services
                .AddScoped<IPlugCommonExecute, MatlabPlugCommonExecuteService>();
