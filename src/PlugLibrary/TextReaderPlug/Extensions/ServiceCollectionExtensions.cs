...
namespace TextReaderPlug.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            services
                .AddScoped<IPlugCommonSettingContent, Services.TextReaderPlugCommonSettingContent>()
                .AddScoped<IPlugCommonExecute, TextReaderPlugCommonExecuteService>();
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddTextReaderExecute(this IServiceCollection services)
        {
            services
                .AddScoped<IPlugCommonExecute, TextReaderPlugCommonExecuteService>();
