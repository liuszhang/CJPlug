...
namespace JavaScriptPlug.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddJavaScript(this IServiceCollection services)
        {
            services
                .AddScoped<IPlugCommonSettingContent, Services.JavaScriptPlugCommonSettingContent>()
                .AddScoped<IPlugCommonExecute, JavaScriptPlugCommonExecuteService>();
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddJavaScriptExecute(this IServiceCollection services)
        {
            services
                .AddScoped<IPlugCommonExecute, JavaScriptPlugCommonExecuteService>();
