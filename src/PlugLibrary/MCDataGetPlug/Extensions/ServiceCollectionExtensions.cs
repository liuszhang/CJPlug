...
namespace MCDataGetPlug.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddMCDataGet(this IServiceCollection services)
        {
            services
                .AddScoped<IPlugCommonSettingContent, Services.MCDataGetPlugCommonSettingContent>()
                .AddScoped<IPlugCommonExecute, MCDataGetPlugCommonExecuteService>();
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddMCDataGetExecute(this IServiceCollection services)
        {
            services
                .AddScoped<IPlugCommonExecute, MCDataGetPlugCommonExecuteService>();
